...
Hit help button to find out more about how to use me</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                [
                                        ...
                                        InlineKeyboardButton('Feedback 👥', url='https://telegram.me/NXTBinner')
                                    ],[
                                        InlineKeyboardButton('🧑‍🔧 Owner', url='https://t.me/lucy_x_999'),
                                    ]]
                            ),        
...
<b>▷ 🧑‍🔧 Developer:</b> <a href="https://t.me/lucy_x_999">Zaute Km</a>
""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
        ...
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=message.chat.id,
                    text="Sorry, You are Banned to use me. Contact my [master](https://t.me/lucy_x_999).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await c.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Join Updates Channel", url=f"https://t.me/NXTBinner")
                        ]
                    ]
                ),
                parse_mode="markdown"
            ...
            await c.send_message(
                chat_id=message.chat.id,
                text="Something went Wrong. Contact my [master](https://t.me/lucy_x_999).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
